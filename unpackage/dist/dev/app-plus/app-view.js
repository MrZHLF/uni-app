...
Z([3,'topic-list u-f'])
Z(z[40])
Z([3,'../../static/demo/topicpic/15.jpeg'])
Z([3,'#话题名称#'])
Z([3,'话题描述'])
Z([3,'动态 10 今日 5'])
...
var x=['./components/common/common-list.wxml','./components/common/load-more.wxml','./components/common/no-thing.wxml','./components/common/uploud-images/uploud-images.wxml','./components/index/index-list.wxml','./components/index/swiper-tab-head.wxml','./components/news/news-nav-bar.wxml','./components/news/topic-nav.wxml','./components/uni-icon/uni-icon.wxml','./components/uni-nav-bar/uni-nav-bar.wxml','./components/uni-popup/uni-popup.wxml','./components/uni-status-bar/uni-status-bar.wxml','./pages/add-input/add-input.wxml','./pages/home/home.wxml','./pages/index/index.wxml','./pages/news/news.wxml','./pages/paper/paper.wxml','./pages/search/search.wxml'];d_[x[0]]={}
...
var z=gz$gwx_9()
var hCE=_mz(z,'view',['bindtap',0,'class',1,'data-event-opts',1,'style',2],[],e,s,gg)
_(r,hCE)
return r
}
...
var lGE=_mz(z,'view',['class',1,'style',1],[],e,s,gg)
var aHE=_v()
_(lGE,aHE)
if(_oz(z,3,e,s,gg)){aHE.wxVkey=1
var tIE=_mz(z,'uni-status-bar',['bind:__l',4,'vueId',1],[],e,s,gg)
_(aHE,tIE)
}
var eJE=_mz(z,'view',['class',6,'style',1],[],e,s,gg)
var bKE=_mz(z,'view',['bindtap',8,'class',1,'data-event-opts',2],[],e,s,gg)
var oLE=_v()
_(bKE,oLE)
...
var oTE=_v()
_(cSE,oTE)
if(_oz(z,23,e,s,gg)){oTE.wxVkey=1
var lUE=_n('view')
_rz(z,lUE,'class',24,e,s,gg)
var aVE=_oz(z,25,e,s,gg)
_(lUE,aVE)
_(oTE,lUE)
}
var tWE=_n('slot')
...
oTE.wxXCkey=1
_(eJE,cSE)
var eXE=_mz(z,'view',['bindtap',26,'class',1,'data-event-opts',2],[],e,s,gg)
var bYE=_v()
_(eXE,bYE)
if(_oz(z,29,e,s,gg)){bYE.wxVkey=1
var x1E=_n('view')
_rz(z,x1E,'class',30,e,s,gg)
var o2E=_mz(z,'uni-icon',['bind:__l',31,'color',1,'size',2,'type',3,'vueId',4],[],e,s,gg)
_(x1E,o2E)
_(bYE,x1E)
}
var oZE=_v()
...
var oFE=_v()
_(cEE,oFE)
if(_oz(z,40,e,s,gg)){oFE.wxVkey=1
var o6E=_n('view')
_rz(z,o6E,'class',41,e,s,gg)
var c7E=_v()
_(o6E,c7E)
if(_oz(z,42,e,s,gg)){c7E.wxVkey=1
var o8E=_mz(z,'uni-status-bar',['bind:__l',43,'vueId',1],[],e,s,gg)
_(c7E,o8E)
}
var l9E=_n('view')
...
var z=gz$gwx_11()
var tAF=_n('view')
var eBF=_mz(z,'view',['bindtap',0,'catchtouchmove',1,'class',1,'data-event-opts',2,'hidden',3,'style',4],[],e,s,gg)
_(tAF,eBF)
var bCF=_mz(z,'view',['class',6,'hidden',1],[],e,s,gg)
...
var fGF=_mz(z,'view',['bindtap',10,'class',1,'data-event-opts',2],[],e,s,gg)
_(oDF,fGF)
}
oDF.wxXCkey=1
_(tAF,bCF)
...
var z=gz$gwx_13()
var oLF=_n('view')
var lMF=_mz(z,'uni-nav-bar',['bind:__l',0,'bind:clickLeft',1,'bind:clickRight',1,'data-event-opts',2,'leftIcon',3,'rightText',4,'statusBar',5,'vueId',6,'vueSlots',7],[],e,s,gg)
var aNF=_mz(z,'view',['bindtap',9,'class',1,'data-event-opts',2],[],e,s,gg)
...
var oRF=_mz(z,'textarea',['bindinput',15,'data-event-opts',1,'placeholder',2,'value',3],[],e,s,gg)
_(bQF,oRF)
_(oLF,bQF)
var xSF=_mz(z,'uploud-images',['bind:__l',19,'bind:uploud',1,'data-event-opts',2,'vueId',3],[],e,s,gg)
_(oLF,xSF)
var oTF=_mz(z,'uni-popup',['bind:__l',23,'bind:hidePopup',1,'data-event-opts',2,'mode',3,'position',4,'show',5,'vueId',6,'vueSlots',7],[],e,s,gg)
var fUF=_n('view')
_rz(z,fUF,'class',31,e,s,gg)
var cVF=_n('view')
_rz(z,cVF,'class',32,e,s,gg)
var hWF=_mz(z,'image',['mode',33,'src',1],[],e,s,gg)
_(cVF,hWF)
_(fUF,cVF)
var oXF=_n('view')
...
_(e4F,b5F)
_(fUF,e4F)
var o6F=_mz(z,'button',['bindtap',39,'data-event-opts',1,'type',2],[],e,s,gg)
...
var z=gz$gwx_15()
var oBG=_n('view')
var cCG=_mz(z,'swiper-tab-head',['bind:__l',0,'bind:tabtap',1,'data-event-opts',1,'tabBars',2,'tabIndex',3,'vueId',4],[],e,s,gg)
_(oBG,cCG)
var oDG=_n('view')
_rz(z,oDG,'class',6,e,s,gg)
var lEG=_mz(z,'swiper',['bindchange',7,'class',1,'current',2,'data-event-opts',3,'style',4],[],e,s,gg)
var aFG=_v()
_(lEG,aFG)
var tGG=function(bIG,eHG,oJG,gg){
var oLG=_n('swiper-item')
var fMG=_mz(z,'scroll-view',['scrollY',-1,'bindscrolltolower',16,'class',1,'data-event-opts',2],[],bIG,eHG,gg)
var cNG=_v()
_(fMG,cNG)
...
var tUG=_mz(z,'index-list',['bind:__l',24,'index',1,'item',2,'vueId',3],[],oRG,cQG,gg)
_(lSG,tUG)
return lSG
}
hOG.wxXCkey=4
_2z(z,22,oPG,bIG,eHG,gg,hOG,'item','index1','index1')
var eVG=_mz(z,'load-more',['bind:__l',28,'loadtext',1,'vueId',2],[],bIG,eHG,gg)
_(cNG,eVG)
}
else{cNG.wxVkey=2
var bWG=_n('view')
_rz(z,bWG,'class',31,bIG,eHG,gg)
var oXG=_mz(z,'image',['mode',32,'src',1],[],bIG,eHG,gg)
_(bWG,oXG)
_(cNG,bWG)
var xYG=_mz(z,'no-thing',['bind:__l',34,'vueId',1],[],bIG,eHG,gg)
_(cNG,xYG)
}
cNG.wxXCkey=1
cNG.wxXCkey=3
...
aFG.wxXCkey=4
_2z(z,14,tGG,e,s,gg,aFG,'items','index','index')
_(oDG,lEG)
_(oBG,oDG)
_(r,oBG)
return r
...
var z=gz$gwx_16()
var f1G=_n('view')
var c2G=_mz(z,'news-nav-bar',['bind:__l',0,'bind:changTab',1,'data-event-opts',1,'tabBars',2,'tabIndex',3,'vueId',4],[],e,s,gg)
_(f1G,c2G)
var h3G=_n('view')
_rz(z,h3G,'class',6,e,s,gg)
var o4G=_mz(z,'swiper',['bindchange',7,'class',1,'current',2,'data-event-opts',3,'style',4],[],e,s,gg)
var c5G=_n('swiper-item')
var o6G=_mz(z,'scroll-view',['scrollY',-1,'bindscrolltolower',12,'class',1,'data-event-opts',2],[],e,s,gg)
var l7G=_v()
_(o6G,l7G)
var a8G=function(e0G,t9G,bAH,gg){
var xCH=_mz(z,'common-list',['bind:__l',19,'index',1,'item',2,'vueId',3],[],e0G,t9G,gg)
_(bAH,xCH)
return bAH
}
l7G.wxXCkey=4
_2z(z,17,a8G,e,s,gg,l7G,'item','index','index')
var oDH=_mz(z,'load-more',['bind:__l',23,'loadtext',1,'vueId',2],[],e,s,gg)
_(o6G,oDH)
_(c5G,o6G)
_(o4G,c5G)
var fEH=_n('swiper-item')
var cFH=_mz(z,'scroll-view',['scrollY',-1,'class',26],[],e,s,gg)
var hGH=_n('view')
_rz(z,hGH,'class',27,e,s,gg)
var oHH=_mz(z,'input',['class',28,'placeholder',1,'placeholderClass',2],[],e,s,gg)
_(hGH,oHH)
_(cFH,hGH)
var cIH=_mz(z,'swiper',['autoplay',31,'class',1,'duration',2,'indicatorDots',3,'interval',4],[],e,s,gg)
var oJH=_v()
_(cIH,oJH)
var lKH=function(tMH,aLH,eNH,gg){
var oPH=_n('swiper-item')
var xQH=_mz(z,'image',['lazyLoad',-1,'mode',40,'src',1],[],tMH,aLH,gg)
_(oPH,xQH)
_(eNH,oPH)
return eNH
}
oJH.wxXCkey=2
_2z(z,38,lKH,e,s,gg,oJH,'item','index','index')
_(cFH,cIH)
var oRH=_mz(z,'topic-nav',['bind:__l',42,'nav',1,'vueId',2],[],e,s,gg)
_(cFH,oRH)
var fSH=_n('view')
...
var cWH=_mz(z,'image',['lazyLoad',-1,'mode',48,'src',1],[],e,s,gg)
_(oVH,cWH)
var oXH=_n('view')
var lYH=_n('view')
